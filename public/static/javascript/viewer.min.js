...
900+players[p].props.playerNumber,e[b]=players[p],b=players[p].props.playerNumber+1500,e[b]=new Shadows(players[p]);if(this.props.explosions.length)for(var v in this.props.explosions)p=this.props.explosions[v],p.dead||(e[p.zIndex]=p);for(v in e)e[v].draw(a,d)};Game.prototype.renderText=function(a){var b=a.canvas.width/2;this.drawMessage(a,this.props.message,(a.canvas.width-b)/2,a.canvas.height/2.2,b,35,!0)};
