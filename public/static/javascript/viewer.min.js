var Destroyable=function(a,b,c,d,e,h,g,k){this.props={id:a,image:b,x:c,y:d,z:e,frameWidth:h?b.width/8:b.width,frameHeight:h?b.height/2:b.height,destroyable:h,destroyedColorIndex:g,currentSpriteFrame:k}};
...
Destroyable.prototype.collides=function(a,b){var c=this.props.x,d=c+this.props.frameWidth,e=this.props.y,h=e+this.props.frameHeight,g=this.props.z-20,k=this.props.z+20;for(player in a){var f=0.2*a[player].props.z,l=0.2*a[player].props.z,m=a[player].props.x+l+100,l=a[player].props.x-l+100,q=a[player].props.y+f,f=a[player].props.y-f,n=a[player].props.z;if(n>=g&&n<=k&&l>=c&&m<=d&&q>=e&&f<=h)return player}return!1};var Game=function(a,b){var c=this;c.props={state:"LOADING",message:!1,defaultText:"Go to http://game.multeor.com on your mobile and enter code "+b+" to join",preloadImages:[],audio:{},images:[],world:!1,worldX:0,worldSpeed:10,destroyed:{},levelPath:a,spriteAnimationFrame:1};$.ajaxSetup({cache:!0});$.getJSON(c.props.levelPath+"/level.json",function(a){c.message("Loading");c.props.world=a;for(var b=0;b<a.length;b++)if("undefined"!=typeof a[b].background&&c.props.preloadImages.push(a[b].background),
a[b].sprites.length)for(var h=0;h<a[b].sprites.length;h++){var g=a[b].sprites[h];"undefined"!=typeof g.path&&-1===$.inArray(g.path,c.props.preloadImages)&&c.props.preloadImages.push(g.path);"undefined"!=typeof g.audio&&"undefined"==typeof c.props.audio[g.audio]&&"none"!=g.audio&&(c.props.audio[g.audio]=null)}Upon.log("Preloading: "+c.props.preloadImages);for(a=0;a<c.props.preloadImages.length;a++)c.loadImage(c.props.preloadImages[a]);c.loadAudio()}).fail(function(a,b,c){throw c;})};
...
Game.prototype.renderBackgrounds=function(a,b,c){for(var d=0;d<=a;d++){var e=this.props.world[b+d];if("undefined"!=typeof e){var e=this.getImage(e.background),h=1E3*d-c,g=0,k=1E3;0>h&&(h=0,g=c,k=1E3-c);h+1E3>canvas.width&&(k=canvas.width-h);"undefined"!=typeof e&&context.drawImage(e,g,0,k,canvas.height,h,0,k,canvas.height)}}};
Game.prototype.renderEntities=function(a,b,c){var d=[],e=0;this.props.spriteAnimationFrame=8.9>this.props.spriteAnimationFrame?this.props.spriteAnimationFrame+0.1:1;for(var h=Math.floor(this.props.spriteAnimationFrame),g=0;g<=a;g++){var k=this.props.world[b+g];if("undefined"!=typeof k)for(sprite in k.sprites){var f=k.sprites[sprite],l=this.props.destroyed[f.id]||!1,m=1E3*g-c+f.left,q=f.top,n=50*f.layer,p=e+1E3*f.layer;f.left-=2*(f.layer-1);d[p]=new Destroyable(f.id,this.getImage(f.path),m,q,n,f.destroyable,
l,h);f.destroyable&&!l&&(l=d[p].collides(players,c),!1!==l&&(m=$.inArray(players[l].props.color,playerColors)+1,this.props.destroyed[f.id]=m,0<f.score&&(players[l].updateScore(f.score),f.audio&&"none"!=f.audio&&this.props.audio[f.audio].volume(0.2).play())));e++}}for(player in players)p=1E3*players[player].props.layer+900+players[player].props.playerNumber,d[p]=players[player];for(key in d)d[key].draw(context,c)};
Game.prototype.renderText=function(){var a=canvas.width/2;this.drawMessage(context,this.props.message,(canvas.width-a)/2,canvas.height/2.2,a,35,!0)};
...
Game.prototype.drawMessage=function(a,b,c,d,e,h,g){a.save();a.font="30px ablas_altbold";a.fillStyle="#FFFFFF";b=b.toString().split(" ");for(var k="",f=0;f<b.length;f++){var l=k+b[f]+" ",m=a.measureText(l).width;m>e?(a.fillText(k,c,d),k=b[f]+" ",d+=h):(g&&(c=canvas.width/2-m/2),k=l)}a.fillText(k,c,d);a.restore()};var Player=function(a,b,c,d,e){this.props={playerId:a,playerNumber:e,x:0,y:0,z:0,vector:[0,0,0],minX:60,maxX:b-180,minY:0,maxY:c,minZ:50,maxZ:150,color:d,lastMoves:[],meteorHeadAngle:0,locked:!1,endX:0,endY:0,endZ:60};this.props.y=e*(this.props.minZ+18)};
Player.prototype.draw=function(a){this.updatePosition();if(9<this.props.lastMoves.length){var b=this.props.lastMoves[0][1],c=this.props.lastMoves[6][0],d=this.props.lastMoves[6][1],e=this.props.lastMoves[7][0],h=this.props.lastMoves[7][1],g=100+this.props.lastMoves[9][0],k=this.props.lastMoves[9][1];a.lineWidth=this.props.z;var f=a.createLinearGradient(0,0,g-a.lineWidth/2,0);f.addColorStop(1,this.props.color);f.addColorStop(0,"rgba(0,0,0,0)");a.strokeStyle=f;a.lineCap="round";a.beginPath();a.moveTo(0,
b);a.bezierCurveTo(c,d,e,h,g,k);a.stroke();b=0.2*this.props.z;c=0.2*this.props.z;d=this.props.x-c;e=this.props.x+c;h=this.props.y+b;f=this.props.y-b;a.save();a.fillStyle="rgba(0,0,0,.6)";a.translate(g,k);this.props.meteorHeadAngle++;a.rotate(Math.PI/180*this.props.meteorHeadAngle);a.fillRect(c,b,d-e,f-h);a.restore()}};
...
this.props.maxY-a);this.props.y<this.props.minY+a&&(this.props.y=this.props.minY+a)}this.props.lastMoves.push([this.props.x,this.props.y]);10<this.props.lastMoves.length&&this.props.lastMoves.shift()};Player.prototype.updateScore=function(a){this.props.score+=a;socket.emit("update-score",{viewerId:viewerId,gameRoom:gameRoom,playerId:this.props.playerId,score:this.props.score})};Player.prototype.lockPlayer=function(){this.props.locked=!0};var socket=io.connect(window.location.hostname+":3333"),canvas=document.getElementById("canvas"),context=canvas.getContext("2d"),players={},getReadyInterval=!1,game=!1,playerColors="rgba(255,0,36,0.8) rgba(8,103,255,0.8) rgba(255,110,221,0.8) rgba(255,255,0,0.8) rgba(110,8,157,0.8) rgba(0,255,247,0.8) rgba(16,230,34,0.8) rgba(255,174,26,0.8)".split(" "),playerColorsShuffled=shuffleArray(playerColors.slice(0)),gameRoom=sessionStorage.getItem("game-room")||Math.floor(1E4*Math.random()+1E4);
...
$(document).ready(function(){canvas.width=$(window).width();canvas.height=600;var a=new Game("/levels/forest",gameRoom);socket.emit("new-viewer",{viewerId:viewerId,gameRoom:gameRoom});socket.on("game-end",function(b){a.abortGame()});socket.on("game-invalid",function(a){sessionStorage.setItem("viewer-id","");sessionStorage.setItem("game-room","");alert("Sorry, no game hijacking");document.location="/";logGAEvent("Room hijacking?")});socket.on("update-game-state",function(b){var c=0,d;for(d in b.players)c++;
1===c&&a.getReady();c=0;for(d in b.players){var e=b.players[d];c++;if("undefined"==typeof players[e]){var h=playerColorsShuffled.splice(0,1)[0];players[e]=new Player(e,canvas.width,canvas.height,h,c);socket.emit("update-player-color",{viewerId:viewerId,gameRoom:gameRoom,playerId:e,playerColor:h})}}for(var g in players){c=!1;for(d in b.players)b.players[d]==g&&(c=!0);c||delete players[g]}});socket.on("player-update",function(a){if("undefined"==typeof players[a.pid])return!1;players[a.pid].props.vector=
a.v});(function c(d){requestAnimationFrame(c);a&&a.tick(d)})()});function logGAEvent(a,b,c){"undefined"!==typeof _gaq&&("undefined"!==typeof b&&"undefined"!==typeof c?(Upon.log("Viewer, "+a+", "+b+", "+c),_gaq.push(["_trackEvent","Viewer",a,b,c])):_gaq.push(["_trackEvent","Viewer",a]))}function shuffleArray(a){for(var b,c,d=a.length;d;b=parseInt(Math.random()*d),c=a[--d],a[d]=a[b],a[b]=c);return a}
(function(){for(var a=0,b=["ms","moz","webkit","o"],c=0;c<b.length&&!window.requestAnimationFrame;++c)window.requestAnimationFrame=window[b[c]+"RequestAnimationFrame"],window.cancelAnimationFrame=window[b[c]+"CancelAnimationFrame"]||window[b[c]+"CancelRequestAnimationFrame"];window.requestAnimationFrame||(window.requestAnimationFrame=function(b,c){var h=(new Date).getTime(),g=Math.max(0,16-(h-a)),k=window.setTimeout(function(){b(h+g)},g);a=h+g;return k});window.cancelAnimationFrame||(window.cancelAnimationFrame=
