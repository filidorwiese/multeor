...
exports.listen = function(server) {
    ...
    io.sockets.on('connection', function(socket) {
        ...
        socket.on('new-viewer', function(data){
            console.log('new-viewer: ' + JSON.stringify(data));
            /*
            // FIXME: validate data.gameRoom?
            if (typeof players[socket.id] == 'undefined') {
                assignNewViewer(socket, data.gameRoom);
            }*/
        });
        ...
        socket.on('new-player', function(data){
            ...
            // FIXME: validate data.gameRoom?
            if (typeof players[socket.id] == 'undefined') {
                nextPlayerNumber = assignNewPlayerConfig(socket, data.gameRoom);
            }
...
function assignNewPlayerConfig(socket, gameRoom) {
...
function assignNewViewer(socket, gameRoom) {
